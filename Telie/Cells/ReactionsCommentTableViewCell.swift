...
class ReactionsCommentTableViewCell: UITableViewCell {
    ...
    // MARK: - Data Vars
    static let reuseIdentifier = "ReactionsCommentTableViewCell"
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        reactionNameLabel.font = .systemFont(ofSize: 12, weight: .medium)
        ...
        reactionContentLabel.lineBreakMode = .byWordWrapping
